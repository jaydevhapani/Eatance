...
import { flushAllData, saveLanguage, setIsTermsAndConditionsAccepted } from '../utils/AsyncStorageHelper';
...
class AccountContainer extends React.Component {
    ...
    render() {
        return (
            <View pointerEvents={this.state.isLoading ? 'none' : 'auto'} style={styles.mainContainer}>
                <NavigationEvents onWillFocus={this.onWillFocusAccountContainer} />
                {this.state.isLoading ? <EDProgressLoader /> : null}
                {this.logoutDialogue()}
                <EDThemeHeader icon={'menu'} onLeftButtonPress={this.buttonMenuPressed} title={strings('accountsNew.title')} />
                <KeyboardAwareScrollView
                    ...
                    <View style={styles.childContainer}>
                        {this.props.isLoggedIn ?
                            <View>
                                <EDAccountItem onPress={this.onPressHandler} icon={Assets.edit_profile} title={strings('accountsNew.editProfile')} />
                                <EDAccountItem onPress={this.onPressHandler} icon={Assets.password_account} title={strings('accountsNew.changePassword')} />
                            </View> : null}
                        <EDAccountItem isLoggedIn={this.props.isLoggedIn} onPress={this.onPressHandler} UserID={this.props.UserID} isForLanguage={true} icon={Assets.language} title={strings('accountsNew.language')} />
                        {this.props.isLoggedIn ?
                            <EDAccountItem onPress={this.onPressHandler} icon={Assets.logout} title={strings('accountsNew.signout')} /> : null}
                    </View>
                </KeyboardAwareScrollView>
            </View>
        );
    ...
    logoutDialogue = () => {
        return (
            <EDPopupView isModalVisible={this.state.isLogout}>
                <EDConfirmationDialogue onYesClick={this.onYesClick} onNoClick={this.onNoClick} title={strings('accountsNew.logoutConfirm')} />
            </EDPopupView>
        );
    }
    //#endregion
