...
class HomeContainerNew extends React.PureComponent {
  ...
  onDidFocusHomeContainer = () => {
    ...
    if (
      this.objStoreDetails !== undefined &&
      this.props.objStoreDetails !== undefined &&
      this.objStoreDetails.store_id !== this.props.objStoreDetails.store_id
    ) {
      this.strOnScreenTitle = '';
      this.strOnScreeMessage = '';
      this.strSearchMessage = '';
  ...
  render() {
    ...
    return (
      <BaseContainer
        title={
          this.props.objStoreDetails !== undefined
            ? this.props.objStoreDetails.name || ''
            : ''
        }
        left={'menu'}
        ...
        {/* SCREEN FOCUS EVENT */}
        <NavigationEvents
          onWillBlur={this.onWillBlurHomeContainer}
          onDidFocus={this.onDidFocusHomeContainer}
          onWillFocus={this.onWillFocusHomeContainer}
        />
              ...
              <View
                ...
                {this.storesCount > 1 ? (
                  <TouchableOpacity
                    ...
                    style={{backgroundColor: EDColors.palePrimary, height: 40}}>
                    <EDRTLView
                      style={{
                      ...
                      <EDRTLText
                        ...
                        title={strings('homeNew.switchStore')}
                      />
                      <MaterialIcon
                ...
                <ShopByCategoryComponent
                  ...
                  title={strings('homeNew.shopByCategory')}
                  shopByData={this.arrayCategories}
                  onViewAllHandler={this.buttonViewAllCategoriesPressed}
                />
                ...
                <ProductsForYouComponent
                  ...
                  shopByData={this.arrayFeaturedProducts}
                  onViewAllHandler={this.buttonViewAllFeaturedProductsPressed}
                ...
                <ReviewsCarousel
                  ...
                  dummyReview={{
                    review:
                      strings('homeNew.noReviewsTitle') +
                      '. ' +
                      strings('homeNew.noReviewsMessage'),
                    first_name:
                      this.objStoreDetails !== undefined
                        ? this.objStoreDetails.name || APP_NAME
                        : APP_NAME,
                  }}
                  title={strings('homeNew.reviews')}
                  reviewsData={this.arrayReviews}
                  onViewAllHandler={this.buttonViewAllReviewsPressed}
                />

                {/* BRANDS */}
                <ShopByBrandComponent
                  onSelectionHandler={this.onBrandSelectionHandler}
                  title={strings('homeNew.shopByBrands')}
                  shopByData={this.arrayBrands}
                  onViewAllHandler={this.buttonViewAllBrandsPressed}
                />
          ...
          <Animated.View
            ...
            <View style={{}}>
              ...
              this.state.arrayProducts.length > 0 ? (
                ...
                />
              ) : this.strSearchMessage !== undefined &&
                this.strSearchMessage.trim().length > 0 ? (
                <View
                  style={{
                    shadowOpacity: 0.25,
                    shadowRadius: 5,
  ...
  renderProductItem = (productToLoad) => {
    return (
      <TouchableOpacity
        ...
        style={{}}>
        <EDRTLText
          style={stylesHomeContainer.itemName}
          title={productToLoad.item.name || ''}
        />
      </TouchableOpacity>
    );
  };
  ...
  renderHeaderSearchResults = () => {
    return this.state.isSearchLoading ? (
      <View style={{backgroundColor: EDColors.white, paddingVertical: 20}}>
        <Spinner
          style={stylesHomeContainer.spinner}
  ...
  buttonViewAllFeaturedProductsPressed = () => {
    ...
    this.props.navigation.navigate('productsList', {
      listType: ProductsListType.featuredProducts,
    });
  };
  ...
  onBrandSelectionHandler = (selectedBrand) => {
    ...
    this.props.navigation.navigate('productsList', {
      listType: ProductsListType.brands,
      entityFromHomeScreen: selectedBrand,
    });
  };
  //#endregion
  ...
  onHomeSuccess = (objSuccess) => {
    ...
    if (
      ...
      objData.featured_brands instanceof Array
    ) {
      this.arrayBrands = objData.featured_brands;
    }

    if (
      objData.featured_category !== undefined &&
      objData.featured_category instanceof Array
    ) {
      this.arrayCategories = objData.featured_category;
    }

    if (
      objData.store !== undefined &&
      objData.store instanceof Array &&
      objData.store.length > 0
    ) {
    ...
    if (
      objData.popular_item !== undefined &&
      objData.popular_item instanceof Array
    ) {
    ...
    if (
      objData.google_map_api_key !== undefined &&
