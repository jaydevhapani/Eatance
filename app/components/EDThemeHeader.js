            ...
            <View>
                ...
                <View style={[styles.backButtonContainer, { alignItems: isRTLCheck() ? 'flex-end' : 'flex-start' }]}>
                    <TouchableOpacity onPress={this.props.onLeftButtonPress}>
                        <MaterialIcon size={25} color={EDColors.white} name={this.props.icon || 'arrow-back'} />
                    </TouchableOpacity>
                </View>
                <View style={styles.welcomeContainer}>
                    <EDRTLText style={styles.welcomeText} title={strings('login.welcome')} />
...
export const styles = StyleSheet.create({
    ...
    welcomeContainer: { position: 'absolute', marginHorizontal: 20, bottom: '20%', width: Metrics.screenWidth - 40 },
    welcomeText: { fontFamily: EDFonts.light, fontSize: getProportionalFontSize(16), color: EDColors.white },
    titleText: { fontFamily: EDFonts.bold, fontSize: getProportionalFontSize(28), color: EDColors.white },
});
