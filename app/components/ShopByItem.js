...
export default class ShopByItem extends React.PureComponent {
    ...
    render() {
        return (
            <TouchableOpacity onPress={this.onPressHandler} activeOpacity={0.8} style={[style.parentContainer, this.props.isForBrands ? { height: PARENT_WIDTH * 1.25 } : {}]}>
                <View style={[style.shadowContainer]}>
                    <View style={[style.shopByImageContainer, this.props.isForBrands ? {} : {}]}>
                        <EDImage
                            resizeMode='contain'
                            style={[style.shopByImage,
...
export const style = StyleSheet.create({
    parentContainer: {
        width: PARENT_WIDTH, height: PARENT_WIDTH,
