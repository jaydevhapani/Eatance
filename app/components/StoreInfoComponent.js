        ...
        return objStoreDetails == undefined ? null : (
            <TouchableOpacity onPress={this.onStoreSelectionHandler}>
                <View>
                    ...
                    <EDImage placeholder={Assets.logo} style={style.storeImage} source={objStoreDetails.image} />
                    <View style={style.storeInfo}>
                        <View style={style.storeInfoChildContainer}>
                            ...
                            <TextViewLeftImage
                                textStyle={{ flex: 1 }}
                                style={{ flex: 1, alignItems: 'flex-start', paddingHorizontal: 0, marginBottom: 10 }}
                                image={'location-pin'}
                            ...
                            <EDRTLView style={style.bottomContainer}>
                                {/* STAR RATING */}
                                {objStoreDetails.rating !== undefined && objStoreDetails.rating !== null && objStoreDetails.rating > 0
                                    ? <StarRating
...
export const style = StyleSheet.create({
    imageContainer: {
        ...
        backgroundColor: EDColors.white, alignSelf: 'center', width: '95%', height: Metrics.screenHeight * 0.2
    },
    storeImage: {
        // tintColor: EDColors.white,
        zIndex: 1000, shadowOpacity: 0.25,
        shadowRadius: 5,
        borderRadius: 8,
        borderColor: EDColors.transparent,
        borderWidth: 1,
        ...
        shadowOffset: { height: 0, width: 0 },
        // margin: 15,
        backgroundColor: EDColors.transparent, alignSelf: 'center', width: '95%', height: (Metrics.screenHeight * 0.2)
    },
    storeInfo: {
        shadowOpacity: 0.25,
        shadowRadius: 5,
    ...
    storeName: {
        ...
        fontFamily: EDFonts.bold, fontSize: getProportionalFontSize(16), color: EDColors.textAccount
    },
    noReviews: {
